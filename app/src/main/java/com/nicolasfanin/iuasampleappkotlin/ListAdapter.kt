...
class ListAdapter(val data: List<Color>) : RecyclerView.Adapter<ListAdapter.PalleteViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PalleteViewHolder =
        PalleteViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.item_color_view, parent, false))
    ...
    class PalleteViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
